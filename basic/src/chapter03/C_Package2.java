...
public class C_Package2 {
	...
	public static void main(String[] args) {
		...
		//만약 동일한 key가 존재한다면 원래의 value를 덮어씌움
		map.put("Apple", "사과");
		...
		//containskey(): Map에 특정 키가 존재하는 지 확인
		System.out.println(map.containsKey("Banana"));
		
		//get(): Map에서 특정 key를 가지는 요소를 반환
		System.out.println(map.getOrDefault("Banana", "없음"));
		
		//remove(): Map에서 특정 key를 가지고 key와 value의
		//삭제 작업에 성고하면 key에 해당되는 value를 반환
		...
		//1. 문제점 : 사용 혹은 추가 작업에서 실수가 발생할 수 있음
