...
class ExampleClass1 {
	...
	// 필드의 데이터 타입 앞에 static이라는 키워드를 붙임
	// 인스턴스 생성 없이 사용 가능
...
class TriangleMath {
	...
	// SPEED_OF_LIGHT은 TriangleMath 클래스의 단일 책임 원칙에 위배
...
public class A_Class_Object {
	...
	static int fx1(int x) {
		...
		// 단, void 반환타입 일때는 return이 필수가 아님
		return y;
	}
	...
	public static void main(String[] args) {
		...
		SmartPhone1 Galaxy = new SmartPhone1();
		
		iPhone.os = "iOS";
		iPhone.telNumber = "010-555-1111";
		Galaxy.os = "Android";
		Galaxy.telNumber = "018-555-2222";
		
		System.out.println(iPhone.os);
		System.out.println(Galaxy.os);
		
		//System.out.println(iPhone.telNumber + "가 ");
		//System.out.println("010-2222-2222로 전화를 겁니다.");
		
		//System.out.println(Galaxy.telNumber + "가 ");
		//System.out.println("010-3333-3333로 전화를 겁니다.");
